...
with tab1:
    ...
    st.image(network_img, caption="Network Architecture", width=None, use_container_width=True)
...
with tab2:
    ...
    if st.session_state.clicked:
        ...
        if image is not None:
            ...
            uploaded_image = PIL.Image.open(image).convert("L")  # Convert to grayscale
